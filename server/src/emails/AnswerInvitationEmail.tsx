...
export default function AnswerInvitationEmail(
  mailData: MailData,
  status: string,
) {
      ...
      <Section style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        >
          <Heading style={styles.title}>
            {status === "accepted" && "Invitation acceptée !"}
            {status === "refused" && "Invitation refusée !"}
          </Heading>
          <Text style={styles.text}>
            {mailData.participant_username}{" "}
            {status === "accepted" && "a accepté "}{" "}
            {status === "refused" && "a refusé "} votre invitation à votre
            activité
          </Text>
          ...
          <Text style={styles.addInfo}>
            Rendez-vous sur TeamUp pour d'autres aventures !
          </Text>
