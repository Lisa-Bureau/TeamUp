...
export default function AnswerRequestEmail(mailData: MailData, status: string) {
      ...
      <Section style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        >
          ...
          <Text style={styles.text}>
            {mailData.organizer_username}{" "}
            {status === "accepted" && "a accepté "}{" "}
            {status === "refused" && "a refusé "} votre demande de participation
            à son activité
          </Text>
          ...
          <Text style={styles.addInfo}>
            {status === "accepted" &&
              "Pour plus d'informations, rendez-vous sur TeamUp !"}
            {status === "refused" &&
              "Rendez-vous sur TeamUp, pour rechercher une nouvelle activité !"}
          </Text>
