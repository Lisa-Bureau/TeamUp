...
export default function CancelActivityEmail(mailData: MailData) {
  ...
  return (
    <>
      <Section style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        >
          <Heading style={styles.title}>Activitée annulée !</Heading>
          <Text style={styles.text}>
            {mailData.organizer_username} a annulé son activité
          </Text>
