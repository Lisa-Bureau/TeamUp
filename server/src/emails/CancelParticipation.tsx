...
export default function CancelParticipationEmail(
  mailData: MailData,
      ...
      <Section style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        >
          <Heading style={styles.title}>
            {(selectedTab === "incoming" || selectedTab === undefined) &&
              "Participation annulée !"}
            {selectedTab === "pending" && "Demande de participation annulée !"}
          </Heading>
          <Text style={styles.text}>
            {mailData.participant_username} a annulé{" "}
            {(selectedTab === "incoming" || selectedTab === undefined) &&
              "sa participation "}{" "}
            {selectedTab === "pending" && "sa demande de participation "} à
            votre activité
          </Text>
          ...
          <Text style={styles.addInfo}>
            {(selectedTab === "incoming" || selectedTab === undefined) &&
              "Pour voir la liste des participants mise à jour, rendez-vous sur TeamUp !"}
            {selectedTab === "pending" &&
              "Pour voir vos autres demandes de participation, rendez-vous sur TeamUp !"}
          </Text>
