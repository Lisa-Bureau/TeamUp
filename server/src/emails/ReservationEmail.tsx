...
export default function ReservationEmail(mailData: MailData) {
      ...
      <Section style={{ marginTop: 16, marginBottom: 16 }}>
        ...
        >
          <Heading style={styles.title}>
            {mailData.auto_validation
              ? "Réservation de "
              : "Demande de réservation de "}
            {mailData.participant_username} !
          </Heading>
          <Text style={styles.text}>
            {mailData.participant_username}{" "}
            {mailData.auto_validation ? "participera " : "souhaite participer "}{" "}
            à votre activité
          </Text>
          ...
          <Text style={styles.addInfo}>
            {mailData.auto_validation
              ? "Pour voir la liste des participants, rendez-vous sur TeamUp !"
              : "Pour plus d'informations et pour accepter ou non sa demande, rendez-vous sur TeamUp !"}
          </Text>
